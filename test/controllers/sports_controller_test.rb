...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { activity_id: @sport.activity_id, plan_id: @sport.plan_id, time: @sport.time } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { activity_id: @sport.activity_id, plan_id: @sport.plan_id, time: @sport.time } }
